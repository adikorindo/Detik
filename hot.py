...
# === KONFIGURASI ===
FB_PAGES = [
    {"page_id": "556612820874746", "access_token": "EAAd1DrRrDJ8BOZC6uaU7dbfhvSaQ6K3gV9LXnnG7v0fEa8yV9li4pozIVqGk5VSTHRj5nUTwPh1ZAZAYbkJYun0qLKySc594j9S7uvmz742BcnZBFKJYkuuBDjPQSJWNvZCIp3lrUiKPg6ssIZCSImkZALeeQCj74dP86UqIkA75AZBIIG5ZBcT9ZAZCTzeeVCGDxKQ"}, #Info Bisnis ID
    {"page_id": "543742442164957", "access_token": "EAAc8IY7AhZAgBOZCcDnCbIGbt7ZBnWt7kektsNfBpPbNewz48VUZCW0xUT3YEO0MWJZAiDK2rJEYtMhY3R5HTJx6MuuTGON8ojnATMmqE6M1IfL4Dov3ZBWIy5QKiZAmdREqr8aK2nxT6DlZClnoJB3OurZAPdELPvhSJmORZBgR3RUt3ZCiDHdZAldPXPUB9M3CRTof"}, #Berita Bisnis ID
...
SITEMAP_URL = "https://hot.detik.com/index/sitemap_image.xml"
...
# === MAIN LOOP ===
posted_articles = set()
JSON_FILE = "posted_articles_hot.json"
...
while True:
    ...
    if 6 <= wib_time < 24:
        ...
        time.sleep(60 * 5)  # Tunggu 1 menit sebelum cek lagi
